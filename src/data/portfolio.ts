...
export const projects: Project[] = [
  {
    ...
    summary: "A public portfolio operations system connecting enquiry intake, validation, ownership, site visits, versioned proposals, approvals, delivery queues and management visibility.",
    status: "Public portfolio application · synthetic data", statusTone: "live", featured: true,
    liveUrl: "https://solar-v2-private.vercel.app", demoLabel: "Open live Solar app",
    stack: ["Next.js", "n8n", "Google Sheets", "Apps Script", "Gmail", "Calendar", "Drive", "Docs"],
    sources: ["Form intake", "Public demo workspace"],
    flow: ["Validate & dedupe", "Lead intelligence", "Assign owner", "Follow up", "Site visit", "Version proposal", "Human approval", "Deliver & track"],
    overview: "The command center turns a multi-stage Solar EPC process into one traceable operating flow. The public application is an isolated portfolio workspace using fictional records; practice changes do not affect Google Sheets or client communications. The embedded case-study demo remains available as a guided preview.",
    ...
    result: "The public portfolio application is live with fictional data, and the core Google Workspace delivery paths have been validated in protected testing. The public workspace excludes production credentials, client records and internal configuration.",
    ...
    metric: { value: "32", label: "automated checks", note: "Verified in the project documentation." },
  },
  {
